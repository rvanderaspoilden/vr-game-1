...
public class @XRIDefaultInputActions : IInputActionCollection, IDisposable
{
        ...
        },
        {
            ...
            ""actions"": [
                ...
                },
                {
                    ""name"": ""Selecting"",
                    ""type"": ""PassThrough"",
                    ""id"": ""317e079b-ec78-439b-b893-97bcb30100e9"",
                    ""expectedControlType"": """",
                    ""processors"": """",
                    ""interactions"": """"
                },
                ...
                },
                {
                    ""name"": ""Activating"",
                    ""type"": ""PassThrough"",
                    ""id"": ""2a185d69-9852-499f-a877-653f76ae97f0"",
                    ""expectedControlType"": """",
                    ""processors"": """",
                    ""interactions"": """"
                },
            ...
            ""bindings"": [
                ...
                {
                    ""name"": """",
                    ""id"": ""76b5801e-c884-4371-8a20-4a9befbb4f8e"",
                ...
                {
                    ""name"": """",
                    ""id"": ""7494a6b6-d00d-45ef-b686-d6cf10e7d62e"",
        ...
        },
        {
            ...
            ""actions"": [
                ...
                },
                {
                    ""name"": ""Selecting"",
                    ""type"": ""PassThrough"",
                    ""id"": ""c16b5568-6d6c-4673-8767-1dddbe2f614c"",
                    ""expectedControlType"": """",
                    ""processors"": """",
                    ""interactions"": """"
                },
                ...
                },
                {
                    ""name"": ""Activating"",
                    ""type"": ""PassThrough"",
                    ""id"": ""830ef120-f83b-4f47-9b28-5a0c2ad06a16"",
                    ""expectedControlType"": """",
                    ""processors"": """",
                    ""interactions"": """"
                },
            ...
            ""bindings"": [
                ...
                {
                    ""name"": """",
                    ""id"": ""177cfce6-890e-4994-b205-227ad544883a"",
                ...
                {
                    ""name"": """",
                    ""id"": ""ca8604b1-016b-4145-8c56-efe928365c2e"",
    ...
    ""controlSchemes"": [
        ...
        m_XRILeftHand_Selecting = m_XRILeftHand.FindAction("Selecting", throwIfNotFound: true);
        m_XRILeftHand_Activate = m_XRILeftHand.FindAction("Activate", throwIfNotFound: true);
        m_XRILeftHand_Activating = m_XRILeftHand.FindAction("Activating", throwIfNotFound: true);
        ...
        m_XRIRightHand_Selecting = m_XRIRightHand.FindAction("Selecting", throwIfNotFound: true);
        m_XRIRightHand_Activate = m_XRIRightHand.FindAction("Activate", throwIfNotFound: true);
        m_XRIRightHand_Activating = m_XRIRightHand.FindAction("Activating", throwIfNotFound: true);
    ...
    private readonly InputAction m_XRILeftHand_Selecting;
    private readonly InputAction m_XRILeftHand_Activate;
    private readonly InputAction m_XRILeftHand_Activating;
    ...
    public struct XRILeftHandActions
    {
        ...
        public InputAction @Selecting => m_Wrapper.m_XRILeftHand_Selecting;
        public InputAction @Activate => m_Wrapper.m_XRILeftHand_Activate;
        public InputAction @Activating => m_Wrapper.m_XRILeftHand_Activating;
        ...
        public void SetCallbacks(IXRILeftHandActions instance)
        {
            if (m_Wrapper.m_XRILeftHandActionsCallbackInterface != null)
            {
                ...
                @Selecting.started -= m_Wrapper.m_XRILeftHandActionsCallbackInterface.OnSelecting;
                @Selecting.performed -= m_Wrapper.m_XRILeftHandActionsCallbackInterface.OnSelecting;
                @Selecting.canceled -= m_Wrapper.m_XRILeftHandActionsCallbackInterface.OnSelecting;
                ...
                @Activating.started -= m_Wrapper.m_XRILeftHandActionsCallbackInterface.OnActivating;
                @Activating.performed -= m_Wrapper.m_XRILeftHandActionsCallbackInterface.OnActivating;
                @Activating.canceled -= m_Wrapper.m_XRILeftHandActionsCallbackInterface.OnActivating;
    ...
    private readonly InputAction m_XRIRightHand_Selecting;
    private readonly InputAction m_XRIRightHand_Activate;
    private readonly InputAction m_XRIRightHand_Activating;
    ...
    public struct XRIRightHandActions
    {
        ...
        public InputAction @Selecting => m_Wrapper.m_XRIRightHand_Selecting;
        public InputAction @Activate => m_Wrapper.m_XRIRightHand_Activate;
        public InputAction @Activating => m_Wrapper.m_XRIRightHand_Activating;
        ...
        public void SetCallbacks(IXRIRightHandActions instance)
        {
            if (m_Wrapper.m_XRIRightHandActionsCallbackInterface != null)
            {
                ...
                @Selecting.started -= m_Wrapper.m_XRIRightHandActionsCallbackInterface.OnSelecting;
                @Selecting.performed -= m_Wrapper.m_XRIRightHandActionsCallbackInterface.OnSelecting;
                @Selecting.canceled -= m_Wrapper.m_XRIRightHandActionsCallbackInterface.OnSelecting;
                ...
                @Activating.started -= m_Wrapper.m_XRIRightHandActionsCallbackInterface.OnActivating;
                @Activating.performed -= m_Wrapper.m_XRIRightHandActionsCallbackInterface.OnActivating;
                @Activating.canceled -= m_Wrapper.m_XRIRightHandActionsCallbackInterface.OnActivating;
